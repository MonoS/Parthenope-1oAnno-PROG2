...
int GradoEntranti(bool m[N][N], int v, int n);
int GradoUscenti(bool m[N][N], int v, int n);
...
int main()
{
    ...
    **/
    ...
    printf("grado uscenti:  %d\n", GradoUscenti(mAddiacenza, v1, N));
    printf("grado entranti: %d\n", GradoEntranti(mAddiacenza, v1, N));
...
int GradoUscenti(bool m[N][N], int v, int n)
{
    ...
    if(v < n)
    {
        //Per contare il numero di archi entranti scorriamo la matrice per righe
...
int GradoEntranti(bool m[N][N], int v, int n)
{
    ...
    if(v < n)
    {
        //Per contare il numero di archi entranti scorriamo la matrice per colonne
        for(i = 0, grado = 0; i < n; i++)
            if(v != i)
                if(m[i][v])
                    grado++;
